...
export function ExpenseByCategoryChart() {
  ...
  const chartData = data.expenseByCategory?.length ? data.expenseByCategory : defaultExpenseCategory
  const rentPct = chartData.find((d) => d.category === "rentOrLease")?.amount ?? 50
  const travelPct = chartData.find((d) => d.category === "travel")?.amount ?? 50
        ...
        <div className="flex items-center gap-2 py-1">
          ...
          <div className="flex flex-col gap-1.5 ml-auto">
            <div className="flex items-center gap-1.5 justify-end">
              ...
              <span className="text-xs font-semibold text-gray-900 dark:text-gray-100">{rentPct}%</span>
            ...
            <div className="flex items-center gap-1.5 justify-end">
              ...
              <span className="text-xs font-semibold text-gray-900 dark:text-gray-100">{travelPct}%</span>
