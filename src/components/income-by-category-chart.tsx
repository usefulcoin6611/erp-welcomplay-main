        ...
        <div className="flex items-center gap-2 py-1">
          ...
          <div className="flex flex-col gap-1.5 ml-auto">
            <div className="flex items-center gap-1.5 justify-end">
              ...
              <span className="text-xs font-semibold text-gray-900 dark:text-gray-100">70%</span>
            ...
            <div className="flex items-center gap-1.5 justify-end">
              ...
              <span className="text-xs font-semibold text-gray-900 dark:text-gray-100">30%</span>
