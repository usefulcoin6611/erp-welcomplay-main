...
function DataGridTableBase({ children }: { children: ReactNode }) {
  ...
  return (
    <table
      ...
      className={cn(
        'w-full align-middle caption-bottom text-left rtl:text-right text-foreground font-normal text-sm border-t-[0.5px] border-b-[0.5px] border-border',
...
function DataGridTableHeadRow<TData>({
  ...
  return (
    <tr
      ...
      className={cn(
        'bg-muted/40',
        props.tableLayout?.headerBorder && '[&>th]:border-b-[0.5px]',
  ...
  return (
    <th
      ...
      className={cn(
        ...
        headerCellSpacing,
        props.tableLayout?.cellBorder && 'border-e-[0.5px]',
        props.tableLayout?.columnsResizable && column.getCanResize() && 'truncate',
        props.tableLayout?.columnsPinnable &&
          column.getCanPin() &&
          '[&:not([data-pinned]):has(+[data-pinned])_div.cursor-col-resize:last-child]:opacity-0 [&[data-last-col=left]_div.cursor-col-resize:last-child]:opacity-0 [&[data-pinned=left][data-last-col=left]]:border-e! [&[data-pinned=right]:last-child_div.cursor-col-resize:last-child]:opacity-0 [&[data-pinned=right][data-last-col=right]]:border-s! [&[data-pinned][data-last-col]]:border-[0.5px] [&[data-pinned][data-last-col]]:border-border data-pinned:bg-muted/90 data-pinned:backdrop-blur-xs',
  ...
  return (
    <div
      {...{
        ...
        className:
          'absolute top-0 h-full w-4 cursor-col-resize user-select-none touch-none -end-2 z-10 flex justify-center before:absolute before:w-[0.5px] before:inset-y-0 before:bg-border before:-translate-x-[0.5px]',
      }}
    />
  );
}
    ...
    <tr
      className={cn(
        ...
        !props.tableLayout?.stripped &&
          ...
          'border-b-[0.5px] border-border [&:not(:last-child)>td]:border-b-[0.5px]',
        props.tableLayout?.cellBorder && '[&_>:last-child]:border-e-0',
  ...
  return (
    <td
      className={cn(
        ...
        props.tableLayout?.columnsPinnable &&
          column.getCanPin() &&
          '[&[data-pinned=left][data-last-col=left]]:border-e! [&[data-pinned=right][data-last-col=right]]:border-s! [&[data-pinned][data-last-col]]:border-[0.5px] [&[data-pinned][data-last-col]]:border-border data-pinned:bg-background/90 data-pinned:backdrop-blur-xs"',
