...
export function PurchaseTab() {
  ...
  const handleApply = () => {
    // Apply filters
    console.log({ startDate, endDate, warehouse, vendor })
  }
  ...
  const generateDailyData = () => {
    const days = []
    for (let i = 0; i < 30; i++) {
      days.push(Math.floor(Math.random() * 300) + 100)
    }
    return days
  }
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between pb-4 border-b">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Daily and monthly purchase analysis with vendor tracking
          </p>
        </div>
        <TooltipProvider>
          <Tooltip>
      ...
      <Tabs value={activeSubTab} onValueChange={setActiveSubTab}>
        ...
        <TabsContent value="daily" className="space-y-6 mt-6">
              ...
              <CardContent className="pt-6">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <h3 className="text-lg font-semibold mt-1">Daily Purchase Report</h3>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <Card className="">
            <CardHeader className="pb-3">
              <h3 className="text-lg font-semibold tracking-tight">Daily Purchase</h3>
              <p className="text-sm text-muted-foreground">Purchase trends over the last 30 days</p>
            </CardHeader>
        ...
        <TabsContent value="monthly" className="space-y-6 mt-6">
            ...
            <Card className="">
              <CardContent className="pt-6">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium text-muted-foreground">Report</p>
                    <h3 className="text-lg font-semibold mt-1">Monthly Purchase Report</h3>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <Card className="">
            <CardHeader className="pb-3">
              <h3 className="text-lg font-semibold tracking-tight">Monthly Purchase</h3>
              <p className="text-sm text-muted-foreground">Purchase trends across 12 months</p>
            </CardHeader>
            <CardContent className="pt-4">
              {mounted ? (
                <Chart
