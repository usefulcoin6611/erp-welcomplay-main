...
export default function InvoiceCreatePage({ params }: InvoiceCreatePageProps) {
  ...
  const [formData, setFormData] = useState({
    customerId: params.id !== 'new' ? params.id : '',
    issueDate: '',
    dueDate: '',
    categoryId: '',
    refNumber: '',
  ...
  const [items, setItems] = useState<InvoiceItem[]>([
    { id: 'row-1', item: '', quantity: '1', price: '0', discount: '0', taxRate: '0', amount: 0 },
  ])
        ...
        <div className="flex flex-1 flex-col bg-gray-100">
          <div className="@container/main flex flex-1 flex-col gap-4 p-4">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-2xl font-semibold">Invoice Create</h1>
              </div>
