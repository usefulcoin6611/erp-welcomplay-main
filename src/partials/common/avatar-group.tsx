...
function AvatarGroup({ size, group, more, className }: AvatarGroupProp) {
  ...
  const renderItem = (each: AvatarItem, index: number) => {
    return (
...
export { AvatarGroup, type AvatarItem as Avatar, type Avatars, type AvatarGroupProp }
